...
class TestMyCyk(unittest.TestCase):
    ...
    def test_is_matching_cfg_for_false_positives(self):
        self.assertTrue(my_cyk.is_matching_cfg(my_cyk.cnf_10palindrome, my_cyk.cnf_10palindrome_start, my_cyk.cnf_10palindrome,
                                               my_cyk.cnf_10palindrome_start, my_cyk.alphabet10, 10))
